...
class TheWorkflow(WorkChain):
	...
	Vo2, Bo2, Bp2 = get_reference(self.inputs.element)
	Vm=(Vo+Vo2)/2
	I = quad(diff_murn_squared, 0.94*Vm, 1.06*Vm , args=(Vo, Bo, Bp, Vo2, Bo2, Bp2))
	self.ctx.fin.append(self.ctx.res.label,Vo,Bo*160.21766208,Bp,np.sqrt(I[0]/Vm/0.12)*1000, "meV")
